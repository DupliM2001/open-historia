        ...
        {!record ? (
            ...
            {visibleEvents.map((event, index) => {
                ...
                return (
                    ...
                    <EventCard event={event} lookups={lookups} footer={offeredInteractiveId && event.id === offeredInteractiveId ? <InteractiveOfferStrip /> : null} />
                    </div>
                );
            })}
            {hasMoreEvents && (
...
const DateWidget = ({
    ...
    return (
        ...
        offeredInteractiveId={shownOffer?.id || ""}
